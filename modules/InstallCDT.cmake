...
eosio_clang_install_and_symlink(llvm-ar lemon-ar)
eosio_clang_install_and_symlink(llvm-nm lemon-nm)
eosio_clang_install_and_symlink(llvm-objcopy eosio-objcopy)
eosio_clang_install_and_symlink(llvm-objdump lemon-objdump)
eosio_clang_install_and_symlink(llvm-readobj lemon-readobj)
eosio_clang_install_and_symlink(llvm-readelf lemon-readelf)
...
eosio_tool_install(lemon-pp)
eosio_tool_install(lemon-wast2wasm)
eosio_tool_install(lemon-wasm2wast)
eosio_tool_install(lemon-cc)
eosio_tool_install(lemon-cpp)
eosio_tool_install(lemon-ld)
eosio_tool_install(lemon-abigen)
eosio_tool_install(lemon-abidiff)
eosio_tool_install(lemon-init)
